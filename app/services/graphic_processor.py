...
class BokehGraph:
    ...
    def linear(self,data,name_x,name_y,title):
        ...
        x_start,x_end, y_start, y_end = DataExcel().max_min(data)
        ...
        # Añadir una línea
        p.line(x='x',y='y0', source=source, line_width=2)
    ...
    def scatter(self, data,name_x, name_y, title):
        ...
        p.scatter(x='x', y='y0', source=source, size=8, color="navy", alpha=0.5)
    ...
    def bar_chartMes(self, data,name_x, name_y, title):
        ...
        p.vbar(x='x', top='y0', width=bar_width, source=source, color="navy", alpha=0.5)
